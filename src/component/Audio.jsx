...
function Audio() {
  ...
  for (const item in activeItem) {
    if (activeItem[item] === true) activeItemTime = jsUcfirst(item);
  }
  ...
  return (
    <>
      <div className="fixed bottom-6 w-screen flex justify-center items-center">
        <p className="absolute left-20 opacity-50 text-sm">
      ...
      <div
        ...
        onClick={() => {
          setVisiableFocusType({ ...initVisiableFocusType, pomodoro: true });
        }}
      >
